...
//     // const { success: deleteSucess} =useSelector(state=>state.deleteJob)
//     const { success: deleteSuccess = false } = useSelector(state => state.deleteJob);
...
const DashJobs = () => {
    ...
    const deleteJobState = useSelector(state => state.deleteJob);
    const deleteSuccess = deleteJobState?.success ?? false;
